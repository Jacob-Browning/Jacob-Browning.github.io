...
/* -------------------- Contact Card Spam Protection -------------------- */

// Create spam-protected email card
...
emailIcon.src = 'https://skillicons.dev/icons?i=gmail';
emailIcon.alt = 'Email';
...
// Obfuscated email click
emailCard.addEventListener('click', () => {
  const user = 'j.b.d3v3lop3r';
